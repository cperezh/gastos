...
insert into staging.movimientos(importe, fvalor, categoria, subcategoria) values (1000, '2021-01-02', 'CAT1', 'SUBCAT1');
insert into staging.movimientos(importe, fvalor, categoria, subcategoria) values (2000, '2021-01-03', 'CAT2', 'SUBCAT2');
insert into staging.movimientos(importe, fvalor, categoria, subcategoria) values (3000, '2021-01-02', 'CAT1', 'SUBCAT1');
insert into staging.movimientos(importe, fvalor, categoria, subcategoria) values (4000, NULL, 'CAT4', 'SUBCAT4');
insert into staging.movimientos(importe, fvalor, categoria, subcategoria) values (6000, '2021-06-01', NULL, 'SUBCAT6');
insert into staging.movimientos(importe, fvalor, categoria, subcategoria) values (7000, '2021-06-01', 'CAT7', NULL);
...
truncate table staging.movimientos
insert into staging.movimientos(importe, fvalor, categoria, subcategoria) values (8000, '2021-07-01', 'CAT8', 'SUBCAT8');
select * from public.subcategoria;
select * from public.dia;
select * from public.gastos_fact